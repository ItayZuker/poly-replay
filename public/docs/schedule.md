...
**Week grid history:** **Live** trade hour cells use the **last occurrence** of each weekday×hour (~**1 week**, zeros included). **Replay** recordings still keep the **latest** day with usable recordings per slot; recording retention defaults to ~**14 days**.
