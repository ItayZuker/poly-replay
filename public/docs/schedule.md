...
| **Profit prediction (¢)** | After trigger: predicted-side Buy must rise by at least this many ¢ before window end for **Right** (1–50, default **5**). Window outcome is ignored. Shown when Prediction is On. |
