...
- Admins manage per-market **Available**, **Recording**, and **retention** in Admin CRM for Replay/Heatmap data; deploy the same app as a recorder and/or live trader (`TRADING_EXECUTOR`) so Replay shares the trading engine
